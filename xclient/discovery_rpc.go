...
func NewRpcRegistryDiscovery(registryAddr string, timeout time.Duration) *RpcRegistryDiscovery {
	if timeout == 0 {
		timeout = defaultUpdateTimeout
	}
	return &RpcRegistryDiscovery{
...
func (d *RpcRegistryDiscovery) Refresh() error {
	...
	servers := strings.Split(resp.Header.Get("X-RpcDemo-Servers"), ",")
